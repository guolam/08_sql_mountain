...
$sql = "INSERT INTO mountain(id,mountain_id, mont, nameKana, area, prefectures, latitude, longitude, created_at, updated_at) VALUES(NULL,:mountain_id, :mont, :nameKana, :area,:prefectures, :latitude, :longitude, now(), now())";
